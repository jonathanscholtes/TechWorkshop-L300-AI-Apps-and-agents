...
def call_handoff(handoff_client: ChatCompletionsClient, handoff_prompt: str, formatted_history: str, phi_4_deployment: str) -> str:
    ...
    with tracer.start_as_current_span("custom_function") as span:
        ...
        try:
            ...
            err_str = str(e)
            print(f"Error during handoff call: {err_str}")
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    print("Starting customer loyalty task...")
    customer_id = "CUST001"
    ...
    try:
        print("Entering main WebSocket loop...")
        while True:
            ...
            try:
                ...
                print("Appending user message to raw_io_history...")
            ...
            # Run handoff service
            print("Starting handoff service...")
            try:
                ...
                print(f"Error during handoff call: {e}")
